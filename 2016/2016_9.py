...
def decompressed_len_v2(unit):
    ...
    while i < len(unit.string):
        ...
        if c == '(' and not active_marker:
            ...
            sub_units.append(RepeatedUnit(active_marker[1], unit.string[i:i + active_marker[0]]))
            i += active_marker[0]
            active_marker = None
        else:
            ...
            while singleton_end < len(unit.string) and unit.string[singleton_end] != '(':
                singleton_end += 1
...
print(decompressed_len_v2(RepeatedUnit(1, '(25x3)(3x3)ABC(2x3)XY(5x2)PQRSTX(18x9)(3x2)TWO(5x7)SEVEN')))
